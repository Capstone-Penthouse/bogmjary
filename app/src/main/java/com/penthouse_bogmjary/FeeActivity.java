...
public class FeeActivity extends AppCompatActivity {
    ...
    private String ip = "192.168.1.158";
...
//                    int port = 8080;
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"elec_y", Integer.parseInt(new_ey));
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"gas_y", Integer.parseInt(new_gy));
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"water_y", new_wy);
