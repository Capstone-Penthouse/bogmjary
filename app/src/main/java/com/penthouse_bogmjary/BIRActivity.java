    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"buildingAddress", value);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"moneyMethod", moneyMethod);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"bo", Integer.parseInt(bo));
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"monthMoney", Integer.parseInt(monthMoney));
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"parking", jucha);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"animal", animal);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"ev", ev);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"big", Integer.parseInt(big));
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"something", something);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"manageMoney", manageMoney);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"monthlyFee",  monthlyFee);
                taskMap.put("bookmark/" + uid + "/" + value+"/"+"otherScore", otherScore);
