    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookmark_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AllBuildingInfo allBuildingInfo = new AllBuildingInfo(0,0,0, 0, ba, "yet", 0, 0, "yet", "yet", "yet", "yet", 0,  "yet", 0, 0,0,0);
                mDatabase.child("bookmark").child(uid).child(ba).setValue(allBuildingInfo);
            }
        });
